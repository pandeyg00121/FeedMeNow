...
const Databox=({title,qty,qtyPercentage,profit})=>(
  <Box w={["full","20%"]} boxShadow={'-1px 0 10px rgba(255,0,0,0.5)'} p={"8"}
  borderRadius={'lg'} 
  >
   <Text fontWeight={"bold"} color={profit?('green.500'):('red.500')} children={title}/>
    <HStack spacing={"6"}>
  ...
  return (
    ...
    <Grid css={{
      ...
      >
        ...
        <Heading children="Dashboard" ml={['0','16']} mb={"16"} textAlign={['center','left']} textTransform={"uppercase"}/>
        ...
        maxW={"900px"}
        >
        <Heading textAlign={["center","left"]} size={"md"} children="Sales Graph" pt={["8","0"]}
          ml={["0","16"]}
        />
        <LineChart/>
        </Box>
        <Grid templateColumns={["1fr","2fr 1fr"]}>
         ...
         <Box p={["0","16"]} borderRadius={"lg"} boxShadow={'-2px 0 10px rgba(255,0,0,0.5)'} maxH={"500px"} maxW={"900px"}  py={"4"} display={"flex"} flexDirection={"column"} alignItems={"center"} ml={["0","16"]}>
            <Heading textAlign={"center"} size={"lg"} mb={"4"} children="Preferences"/>
           <DoughnutChart/>
         </Box>
        </Grid>
      </Box>
